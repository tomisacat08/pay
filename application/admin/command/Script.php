...
use app\admin\service\ScriptService;
...
class Script extends Command
{
    ...
    protected $commandName = 'onceScript';
    protected $option_name = 'opt';

    protected function configure()
    {
        $this->addOption($this->option_name, 'm', Option::VALUE_OPTIONAL, 'scriptName'); //选项值必填
        $this->setName($this->commandName)->setDescription($this->description);
    }

    protected function execute(Input $input, Output $output)
    {
        $handle = new ScriptService();
