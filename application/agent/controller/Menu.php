...
class Menu extends Base {
    ...
    public function add() {
        ...
        if ($postData['url']) {
            $postData['url'] = 'agent/' . $postData['url'];
        }
        $res = AgentMenu::create($postData);
        if ($res === false) {
